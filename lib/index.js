...
exports.server = function(dirPath, options, callback){
  var app, selected_port = options.port||default_port, self = this;
  ...
  if (!options.port) {
    ...
    app.listen(selected_port, function () {
      var args = [].slice.call(arguments)
      args.push(null)
      args.push(selected_port)
      callback.apply(self, args)
    })
  }

  // TODO: give up after tying 10 different ports
}
